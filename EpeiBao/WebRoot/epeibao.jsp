...
<body>
	<div id="box">
		...
		<div id="navlleft">
			...
			<ul class="nav">
				<li style="background:url(images/xinxi.png) no-repeat;"><a
					href="epeibao/operationData/home.jsp" target="main">信 息 总 览</a></li>
				...
				<li style=" background:url(images/xiaoxi.png) no-repeat;"><a
					href="epeibao/message/message.jsp" target="main">消 息 发 布</a></li>
		...
		<div id="navlright">
			...
			<div id="content">
				<iframe scrolling="no" src="epeibao/operationData/home.jsp"
